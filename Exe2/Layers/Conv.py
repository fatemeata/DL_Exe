...
class Conv(BaseLayer):
    ...
    def forward(self, input_tensor):
        ...
        if len(input_tensor.shape) == 3:  # input tensor is 1D
            ...
            for i in range(batch):
                ...
                for k in range(self.num_kernels):
                    for c in range(self.channel):
                        ...
                        # print("x correlation: ", x_corr)
                        # print("x correlation slice: ", x_corr[::2])
            ...
            # f_y = conv_filter_height, f_x: conv_filter_width
            f_x = self.convolution_shape[1]
            f_y = self.convolution_shape[2]
            ...
            input_tensor = np.pad(input_tensor, ((0, 0), (0, 0), (pad_x, pad_x), (pad_y, pad_y-1))) # pad the input tensor
